...
public class StatelessAjaxFormSubmitBehavior extends StatelessAjaxEventBehavior
{
	...
	/**
	 * Creates an {@link StatelessAjaxFormSubmitBehavior} based on lambda expressions
	 * @param eventName the event name
	 * @param onSubmit the {@code SerializableConsumer} which accepts the {@link AjaxRequestTarget}
	 * @return {@link StatelessAjaxFormSubmitBehavior}
	 */
	public static StatelessAjaxFormSubmitBehavior onSubmit(String eventName, SerializableConsumer<AjaxRequestTarget> onSubmit){
		Args.notNull(onSubmit, "onSubmit");
		return new StatelessAjaxFormSubmitBehavior(eventName){
