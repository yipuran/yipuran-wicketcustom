...
/**
 * 枠なしサイズ指定 Modal window component.
 */
public class NoFrameWindow extends Panel{
	private static final long serialVersionUID = 1L;
	private static final ResourceReference JAVASCRIPT = new JavaScriptResourceReference(NoFrameWindow.class, "res/noframe-modal.js");
	private static final ResourceReference CSS = new CssResourceReference(NoFrameWindow.class,	"res/noframe-modal.css");
	...
	private int minimalWidth = 20;
	private int minimalHeight = 20;
	private int initialWidth = 100;
	private int initialHeight = 30;
	 ...
	 * <code>{@link NoFrameWindow#setCloseButtonCallback(NoFrameWindow.CloseButtonCallback)}</code>, no
	 ...
	 * {@link NoFrameWindow#setWindowClosedCallback(NoFrameWindow.WindowClosedCallback)}, no ajax
	 ...
	 */
	public NoFrameWindow(final String id)	{
		super(id);
		initialize();
	}
	 ...
	 * @param model Model
	 */
	public NoFrameWindow(final String id, final IModel<?> model)	{
		super(id, model);
		initialize();
	}
	 ...
	 * @return this
	 */
	public NoFrameWindow setPageCreator(final PageCreator creator){
		setContent(empty);
		pageCreator = creator;
		return this;
	}
	 ...
	 * @return this
	 */
	public NoFrameWindow setCloseButtonCallback(final CloseButtonCallback callback)	{
	 ...
	 * @return this
	 */
	public NoFrameWindow setWindowClosedCallback(final WindowClosedCallback callback)	{
	...
	protected CharSequence getShowJavaScript(){
		return "window.setTimeout(function(){\n" + "  Noframe.Window.create(settings).show();\n" + "}, 0);\n";
	}
	 ...
	 *
	 * <pre>
	 * NoFrameWindow window = new NoFrameWindow(parent, &quot;window&quot;);
	 ...
	 * @return this
	 */
	public NoFrameWindow setMinimalWidth(final int minimalWidth)	{
	 ...
	 *
	 * @param minimalHeight  Minimal height
	 * @return this
	 */
	public NoFrameWindow setMinimalHeight(final int minimalHeight){
	 ...
	 * @return this
	 */
	public NoFrameWindow setInitialWidth(final int initialWidth)	{
	 ...
	 * @return this
	 */
	public NoFrameWindow setInitialHeight(final int initialHeight){
	 ...
	 * @return this
	 */
	public NoFrameWindow setUseInitialHeight(final boolean useInitialHeight){
	 ...
	 * @return this
	 */
	public NoFrameWindow setResizable(final boolean resizable){
	 ...
	 */
	public NoFrameWindow showUnloadConfirmation(final boolean unloadConfirmation){
	 ...
	 * not resizable.
	 *
	 * @param widthUnit  CSS unit for initial window width.
	 * @return this
	 */
	public NoFrameWindow setWidthUnit(final String widthUnit){
	 ...
	 * @return this
	 */
	public NoFrameWindow setHeightUnit(final String heightUnit){
	 ...
	 * @return this
	 */
	public NoFrameWindow setCookieName(final String cookieName){
	 ...
	 * @return this
	 */
	public NoFrameWindow setMaskType(final MaskType mask){
		maskType = mask;
		return this;
	}
	 ...
	 */
	@Override
	public NoFrameWindow remove(final Component component){
	 ...
	 * @return this;
	 */
	public NoFrameWindow setContent(final Component component){
